...
Production-ready settings for Azure App Service deployment.
...
# Azure-ready allowed hosts
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '.azurewebsites.net',  # Azure App Service domains
    '.onrender.com',       # Keep Render support for flexibility
]

# Add Azure-specific hostname (automatically set by Azure)
...
# Database configuration - Azure-ready
if os.getenv('DATABASE_URL'):
    # Production database using DATABASE_URL (works with both Azure and Render)
    import dj_database_url
    DATABASES = {
        'default': dj_database_url.parse(os.getenv('DATABASE_URL'))
    }
elif os.getenv('AZURE_POSTGRESQL_HOST'):
    # Alternative Azure PostgreSQL configuration
    DATABASES = {
        'default': {
...
# Static files storage - WhiteNoise for Azure App Service
...
# Azure App Service automatically sets this
if os.getenv('WEBSITE_HOSTNAME'):
    # Force HTTPS in production on Azure
